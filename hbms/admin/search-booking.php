...
?>
    ...
    <head>
        <title>Sea Horizon | All Booking</title>
                                                ...
                                                ?>
                                                                ...
                                                                foreach ($results as $row) {               ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            ?>
                                                                                <span
                                                                                    class="badge badge-warning"><?php echo htmlentities('Not Updated Yet'); ?></span>
                                                                            <?php elseif ($status == 'Cancelled'): ?>
                                                                                <span
                                                                                    class="badge badge-danger"><?php echo htmlentities($row->Status); ?></span>
                                                                        ...
                                                                        <td class="d-none d-sm-table-cell"><a
                                                                                href="view-booking-detail.php?bookingid=<?php echo htmlentities($row->BookingNumber); ?>"
                                                    ...
                                                    <div align="left">
                                                        <ul class="pagination">
                                                            ...
                                                            <li
                                                                class="<?php if ($pageno >= $total_pages) {
                                                                            echo 'disabled';
                                                                        } ?>">
                                                                <a
