...
?>
    ...
    <head>
        <title>Sea Horizon | Dashboard</title>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="content-top-1">
                                        <h4 class="text-left text-uppercase" style="color: orange"><a
                                ...
                                vertical-center-box-tablet">
                                            ...
                                            <div class="col-xs-9 cus-gh-hd-pro">
                                                <h2 class="text-right no-margin"><?php echo htmlentities($totnewbooking); ?>
                                                </h2>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="margin-bottom:1px;">
                                    <div class="content-top-1">
                                        <h4 class="text-left text-uppercase" style="color: red"><a
                                        ...
                                        <div class="row vertical-center-box vertical-center-box-tablet">
                                            ...
                                            <div class="col-xs-9 cus-gh-hd-pro">
                                                <h2 class="text-right no-margin"><?php echo htmlentities($totappbooking); ?>
                                                </h2>
                                            </div>
                                        </div>
                                        <div class="progress progress-mini">
                                            <div style="width: 100%;" class="progress-bar progress-bar-success bg-red">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="content-top-1">
                                        <h4 class="text-left text-uppercase" style="color: magenta"><a
                                        ...
                                        <div class="row vertical-center-box vertical-center-box-tablet">
                                            ...
                                            <div class="col-xs-9 cus-gh-hd-pro">
                                                <h2 class="text-right no-margin"><?php echo htmlentities($totcanbooking); ?>
                                                </h2>
                                            </div>
                                        </div>
                                        <div class="progress progress-mini">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="content-top-1">
                                        ...
                                        <div class="row vertical-center-box vertical-center-box-tablet">
                                            ...
                                            <div class="col-xs-9 cus-gh-hd-pro">
                                                <h2 class="text-right no-margin"><?php echo htmlentities($totregusers); ?>
                                                </h2>
                                            </div>
                                        </div>
                                        <div class="progress progress-mini">
                                        ...
                                        <div class="row vertical-center-box vertical-center-box-tablet">
                                            ...
                                            <div class="col-xs-9 cus-gh-hd-pro">
                                                <h2 class="text-right no-margin">
                                                    <?php echo htmlentities($totreadqueries); ?></h2>
                                            </div>
                                        </div>
                                        <div class="progress progress-mini">
                                            <div style="width: 100%;" class="progress-bar progress-bar-success bg-red">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="content-top-1">
                                        ...
                                        <div class="row vertical-center-box vertical-center-box-tablet">
                                            ...
                                            <div class="col-xs-9 cus-gh-hd-pro">
                                                <h2 class="text-right no-margin">
                                                    <?php echo htmlentities($totunreadqueries); ?></h2>
                                            </div>
                                        </div>
                                        <div class="progress progress-mini">
                                            <div style="width: 100%;" class="progress-bar progress-bar-danger"></div>
